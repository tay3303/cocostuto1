  ...
  return {
    ...
    execute: function () {
      ...
      _export("movement", movement = (_dec = ccclass('movement'), _dec(_class = (_class2 = class movement extends Component {
        ...
        update(dt) {
          this.node.setPosition(this.node.position.x + this.speed, this.node.position.y); //this.node.angle += 10;
...
//# sourceMappingURL=fb18548327c253d0b1626737e6bf640f91107478.js.map